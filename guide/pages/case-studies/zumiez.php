...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>Delorum Commerce - Case Study: Zumiez</title>
	</head>
	
	<body>
		<div id='zumiez-page-wrapper' class='wrapper page-wrapper'>
			
			<!-- LEFT NAV -->
			<?php include('../../includes/left-nav.php'); ?>
			
			<!-- MAIN PAGE -->
			<div id='zumiez-main-page' class='page main-page'>
				...
				<div id='zumiez-page-background' class='page-background'>
					<div id='zumiez-page-content-wrapper' class='wrapper page-content-wrapper'>
						...
						<div id='zumiez-page-body' class='page-body'>
							<div id='zumiez-content-body' class='content-body'>
								...
								<div id='zumiez-content-right' class='content-right'>
									<div id='zumiez-content-right-top' class='content-right-top'>
				...
				<div id='zumiez-page-bottom' class='page-bottom'></div>
			...
			<!-- RIGHT SIDE -->
			<div id='zumiez-right-side-wrapper' class='wrapper right-side-wrapper'>
				<div id='zumiez-right-side' class='right-side'>
