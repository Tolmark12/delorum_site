...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>Delorum Commerce - Case Study: Idahoan</title>
	</head>
	
	<body>
		<div id='idahoan-page-wrapper' class='wrapper page-wrapper'>
			
			<!-- LEFT NAV -->
			<?php include('../../includes/left-nav.php'); ?>
			
			<!-- MAIN PAGE -->
			<div id='idahoan-main-page' class='page main-page'>
				...
				<div id='idahoan-page-background' class='page-background'>
					<div id='idahoan-page-content-wrapper' class='wrapper page-content-wrapper'>
						...
						<div id='idahoan-page-body' class='page-body'>
							<div id='idahoan-content-body' class='content-body'>
								...
								<div id='idahoan-content-right' class='content-right'>
									<div id='idahoan-content-right-top' class='content-right-top'>
				...
				<div id='idahoan-page-bottom' class='page-bottom'></div>
			...
			<!-- RIGHT SIDE -->
			<div id='idahoan-right-side-wrapper' class='wrapper right-side-wrapper'>
				<div id='idahoan-right-side' class='right-side'>
