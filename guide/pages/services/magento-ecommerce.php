...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>Delorum Commerce - Our Services: Magento E-commerce</title>
	</head>
	
	<body>
		<div id='magento-ecommerce-page-wrapper' class='wrapper page-wrapper'>
			
			<!-- LEFT NAV -->
			<?php include('../../includes/left-nav.php'); ?>
			
			<!-- MAIN PAGE -->
			<div id='magento-ecommerce-main-page' class='page main-page'>
				...
				<div id='magento-ecommerce-page-top' class='page-top'>
					<div id='magento-ecommerce-header' class='header'>
						...
						<div id='magento-ecommerce-header-image' class='header-images services-header-image'>
							<div id='image'>
								<img src='../../images/pages/services/magento-ecommerce/image.png' alt=''/>
							</div>
						</div>
					</div>
				</div>
				
				<div id='magento-ecommerce-page-background' class='page-background'>
					<div id='magento-ecommerce-page-content-wrapper' class='wrapper page-content-wrapper'>

						<div class='dotted-short'></div>

						<div id='magento-ecommerce-page-body' class='page-body services-page-body'>
							<div id='magento-ecommerce-content-body' class='content-body services-content-body'>
									...
									<div id='magento-ecommerce-content-left-body' class='content-left-body services-content-left-body'>
										...
										<div id='' class='feature brown-text capitalize'>
											<ul>
												...
												<li>cybersource: hosted payment (simple PCI compliance) + fraud check</li>
												<li>coremetrics: robust site analytics</li>
												<li>ATG recommendations engine</li>
											</ul>
										</div>
								...
								<div id='magento-ecommerce-content-right' class='content-right services-content-right'>
									<div id='magento-ecommerce-services-list' class='services-list light-green-text'>
										...
										<div id='services' class='capitalize italic bold'>
											<ul>
												...
												<li>hosting environment architecture</li>
				...
				<div id='magento-ecommerce-page-bottom' class='page-bottom'></div>
