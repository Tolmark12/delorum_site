...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<title>Delorum Commerce - Our Services: Service Level Agreement</title>
	</head>
	
	<body>
		<div id='sla-page-wrapper' class='wrapper page-wrapper'>
			
			<!-- LEFT NAV -->
			<?php include('../../includes/left-nav.php'); ?>
			
			<!-- MAIN PAGE -->
			<div id='sla-main-page' class='page main-page'>
				...
				<div id='sla-page-background' class='page-background'>
					<div id='sla-page-content-wrapper' class='wrapper page-content-wrapper'>
						...
						<div id='sla-page-body' class='page-body services-page-body'>
							<div id='sla-content-body' class='content-body services-content-body'>
								...
								<div id='sla-content-right' class='content-right services-content-right'>
									<div id='sla-services-list' class='services-list light-green-text'>
										<h4><span class='uppercase green-text'>support:</span></h4>
										<div id='support' class='capitalize italic bold'>
											<ul>
										...
										<h4><span class='uppercase green-text'>by contract:</span></h4>
										<div id='by-contract' class='capitalize italic bold'>
											<ul>
												<li>code development</li>
												<li>optimization & performance tuning</li>
												<li>custom extentions</li>
												<li>custom interfaces</li>
												<li>custom configuration</li>
												<li>core product upgrades</li>
				...
				<div id='sla-page-bottom' class='page-bottom'></div>
