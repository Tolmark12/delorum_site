...
public class AboutUsProxy extends Proxy implements IProxy
{
	public static const NAME:String = "about_us_proxy";

	public function AboutUsProxy( ):void
	{
		super( NAME );
	}
	...
	private function _handleXmlLoaded ( e:Event ):void
	{
		...
		sendNotification( SiteFacade.ABOUT_US_XML_PARSED, ar )
	}
